...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('public/backend')}}/dist/img/Logo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('public/backend')}}/dist/img/tanzim.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2015-2022 <a href="https://adminlte.io">BSMRH</a>.</strong>
    All rights reserved.
